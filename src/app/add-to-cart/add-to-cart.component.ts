...
export class AddToCartComponent implements OnInit {
  ...
  constructor(private us: UserService, private service: DiginService, private router: Router) {
    this.grandTotal = 0;
  }
  ...
  ngOnInit(): void {
    ...
    this.us.getAllCart(this.thisUser.u_id).subscribe((data: any) => {
      ...
      this.service.setAmount(this.grandTotal);
    })
  }

  updateqty(p: any) {
    this.service.updateCart(p).subscribe((data: any) => {
      this.ngOnInit();
    })
  }
