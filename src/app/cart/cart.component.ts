...
export class CartComponent implements OnInit {
  ...
  constructor(private service: DiginService, private us: UserService) { }

  ngOnInit(): void {
    this.service.getAllCart().subscribe((data: any) => {
      console.log(data);
      this.order = data;
    });
  ...
  delete(o_id: number) {
    ...
    this.service.deleteCart(o_id).subscribe((data: any) => {
      this.order = data;
    });
  }
