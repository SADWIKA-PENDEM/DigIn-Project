...
export class UserPageComponent implements OnInit {
  ...
  thisUser: any;
  public cart: any;
  constructor(private service: DiginService, private u: UserService, private activeRoute: ActivatedRoute, private router: Router) { }
  ...
  searchh(value: any) {
    ...
    this.service.searchContains(value.search).subscribe((data: any) => {
      console.log(data);
      this.product = data;
    });
  }
  ...
  addtocart(item: any) {
    ...
    if (i == this.cart.length) {
      console.log(item);
      this.service.inserCart(item).subscribe((data: any) => {
        Swal.fire({
          position: 'top',
          icon: 'success',
  ...
  search(value: any) {
    console.log(value);
    this.service.searchpi(value).subscribe((data: any) => {
      console.log(data);
      this.product = data;
    })
  }
  ...
  searching() {
    this.service.searching().subscribe((data: any) => {
      console.log(data);
      this.product = data;
    })
  }
